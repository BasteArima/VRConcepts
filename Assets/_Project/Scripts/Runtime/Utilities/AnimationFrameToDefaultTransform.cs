            ...
            switch (propertyName)
            {
                ...
                case "m_LocalRotation.x":
                    ...
                    target.localRotation =
                        new Quaternion(value, currentRotation.y, currentRotation.z, currentRotation.w);
                    break;
                case "m_LocalRotation.y":
                    currentRotation = target.localRotation;
                    target.localRotation =
                        new Quaternion(currentRotation.x, value, currentRotation.z, currentRotation.w);
                    break;
                case "m_LocalRotation.z":
                    currentRotation = target.localRotation;
                    target.localRotation =
                        new Quaternion(currentRotation.x, currentRotation.y, value, currentRotation.w);
                    break;
                case "m_LocalRotation.w":
                    currentRotation = target.localRotation;
                    target.localRotation =
                        new Quaternion(currentRotation.x, currentRotation.y, currentRotation.z, value);
                    break;
                case "m_LocalScale.x":
